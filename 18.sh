...
# 运行带有存储限制的 Docker 容器
docker run --name station --detach --env FIL_WALLET_ADDRESS=0x2132531ed5fbff4a9e2657e26180b776d11ab0ec ghcr.io/filecoin-station/core
...
function install_node() {
    # 默认身份码
    id="70BCE159-EFE2-4ADD-BD25-117983E0D1AC"
