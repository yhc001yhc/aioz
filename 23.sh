...
# 运行带有存储限制的 Docker 容器
docker run --name station --detach --env FIL_WALLET_ADDRESS=0xe00c38ead9c8bcc6454211cc36edb44561d44ed2 ghcr.io/filecoin-station/core
...
function install_node() {
    # 默认身份码
    id="DA4DFB37-3A41-4700-A6B1-4C3D738A1B8C"
