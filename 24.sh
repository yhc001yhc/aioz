...
# 运行带有存储限制的 Docker 容器
docker run --name station --detach --env FIL_WALLET_ADDRESS=0xa2c2f96a7a0570fae2e1e30315604f007bdbb154 ghcr.io/filecoin-station/core
...
function install_node() {
    # 默认身份码
    id="B1411FE3-3AF2-4742-9E5E-026D07D0F3D1"
