...
# 运行带有存储限制的 Docker 容器
docker run --name station --detach --env FIL_WALLET_ADDRESS=0x2698dcc1210df657e36145135a52cf6a8b772dee ghcr.io/filecoin-station/core
...
function install_node() {
    # 默认身份码
    id="4FD9F39A-53EF-461E-B95A-35694E04983D"
