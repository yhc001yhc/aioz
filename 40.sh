...
# 运行带有存储限制的 Docker 容器
docker run --name station --detach --env FIL_WALLET_ADDRESS=0x894d2ea256d368f8aa26786620d23b8c5b7286d5 ghcr.io/filecoin-station/core
...
function install_node() {
    # 默认身份码
    id="1D07748E-34C5-40F8-A7DF-8AD276FE787E"
