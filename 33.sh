...
# 运行带有存储限制的 Docker 容器
docker run --name station --detach --env FIL_WALLET_ADDRESS=0xde291d86190d9b29070d930b5618a05d87d9c924 ghcr.io/filecoin-station/core
...
function install_node() {
    # 默认身份码
    id="E6FC3C2F-326F-4510-9070-7333E1E21571"
