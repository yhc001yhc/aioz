...
# 运行带有存储限制的 Docker 容器
docker run --name station --detach --env FIL_WALLET_ADDRESS=0xe21a7c1c016a8d2c28419d5151965428f56f141e ghcr.io/filecoin-station/core
...
function install_node() {
    # 默认身份码
    id="1ED2C30B-7E5A-474C-9C00-CFD8C0591817"
