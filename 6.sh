...
# 运行带有存储限制的 Docker 容器
docker run --name station --detach --env FIL_WALLET_ADDRESS=0x4665b1a167da8fc0240d1228d9626e091edccd79 ghcr.io/filecoin-station/core
...
function install_node() {
    # 默认身份码
    id="AFB9EF66-1471-4237-BB22-0FF460A43A06"
